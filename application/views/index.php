    ...
    <div class="row">
      <div class="col-sm-3">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-sm-6">
                    <input id="locLatitude" type="text" class="form-control" name="locLatitude" value="" placeholder="Latitude">
                </div>
                <div class="col-sm-6">
                    <input id="locLongitude" type="text" class="form-control" name="locLongitude" value="" placeholder="Longitude">
                </div>
              </div>
            </div>
